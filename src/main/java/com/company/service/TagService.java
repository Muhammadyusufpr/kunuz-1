...
//        entity.setProfile(profileEntity);
    ...
    private TagDTO toDTO(TagEntity entity, LangEnum langEnum) {
        TagDTO dto = new TagDTO();
        dto.setId(entity.getId());
        dto.setKey(entity.getKey());
        dto.setProfileId(entity.getProfileId());
    ...
    public List<TagDTO> getTagList(List<Integer> tagList, LangEnum langEnum) {
        List<TagEntity> entityList = tagRepository.findAllById(tagList);
        List<TagDTO> dtoList = new ArrayList<>();
        for (TagEntity tagEntity : entityList) {
            dtoList.add(toDTO(tagEntity, langEnum));
        }
        return dtoList;
    }
